(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".slider-lots__slider")) new core(".slider-lots__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".slider-quotes__slider")) new core(".slider-quotes__slider", {
